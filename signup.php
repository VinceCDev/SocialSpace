	...
	<div class="row">
		<div class="col-sm-12">
			<div class="main-content">
				<div class="header">
					<h3 style="text-align: center;"><strong>Join Social Space</strong></h3><hr>
				</div>
				<div class="l-part">
					<form action="insert_user.php" method="post">
						...
						<div class="input-group">
							...
							<input id="emai" type="email" class="form-control" placeholder="Email" name="u_email" required="required">
						</div><br>
						<div class="input-group">
						...
						<a style="text-decoration: none; float:left; color: #400090;" data-togglr="tooltip" title="Signin" href="signin.php">Already have an account?</a><br><br>
						<center><button id="signup" class="btn btn-info btn-lg" name="sign_up">Sign Up</button></center>
						<?php include("C:/xampp/htdocs/SocialSpace/insert_user.php");?>
					</form>
				</div>
			</div>
		</div>
