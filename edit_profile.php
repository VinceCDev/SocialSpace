	...
	<div class='col-sm-8' style="background-color: white;">
		<form action="" method="post" enctype="multipart/form-data">
			<table class='table table-bordered table-hover'>
				<tr align="center">
					<td colspan="6" class='active' style="background-color: white;"><h2>Edit Your Profile</h2></td>
				</tr>
				<tr>
                ...
                <tr>
				 ...
				 <tr align="center">
				 	<td colspan="6">
				 	  <input type="submit" class='btn btn-info' name="update" style="background-color: #400090; border-color: #400090;width: 250px;" value="Update">
				 	</td>
				 </tr>
			</table>
	    </form>
