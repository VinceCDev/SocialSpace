    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <div id='profile-img'>
                ...
                <form action='profile.php?u_id=$user_id' method='post' enctype='multipart/form-data'>
                    <label id='update-profile' style='color: #D3D3D3'> Select Profile
                        <input type='file' name='u_image' size='60'/>
                    </label><br><br>
                    <button id='button-profile' name='update' class='btn btn-info' style='background-color: #400090; border-color: #400090;'>Update Profile</button>
                </form>
            </div><br>
            ";
            ?>
...
<div class="row">
	...
	<div class="col-sm-2" style="background-color: #E6E6FA;text-align: center;left: 0.4%;border-radius: 5px">
		<?php
			echo "
				<center><h2><strong>About</strong></h2></center>
				<center><h4><strong>$first_name $last_name</strong></h4></center>
				<p><strong style='color:gray;'><i>$describe_user</i></strong></p><br>
				<p><strong>Live In: </strong> $user_country</p><br>
	...
	<div class="col-sm-6">
		...
		while ($row_posts = mysqli_fetch_array($run_posts)) {
		    ...
		    echo "<div id='own_posts'>
					...
					<a href='single.php?post_id=$post_id' style='float:right; margin-left: 5px;'><button class='btn btn-success'>View</button></a>
 						<a href='edit_post.php?post_id=$post_id' style='float:right; margin-left: 5px;'><button class='btn btn-info'>Edit</button></a>
		            	<a href='functions/delete_post.php?post_id=$post_id' style='float:right; margin-left: 5px;'><button class='btn btn-danger'>Delete</button></a>
		          </div><br>";
